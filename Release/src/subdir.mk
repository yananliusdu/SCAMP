...
src/%.o: ../src/%.cpp
	...
	arm-none-eabi-c++ -std=gnu++14 -D__NEWLIB__ -DNDEBUG -D__CODE_RED -DCORE_M0 -D__USE_LPCOPEN -DNO_BOARD_LIB -DCPP_USE_HEAP -D__LPC43XX__ -D__MULTICORE_M0APP -DCORE_M0APP -DWORKSPACE_PATH='R"RRR(D:\ScampWorkspace4)RRR"' -DPROJECT_NAME='R"RRR(Hector_visual_route_recgnition)RRR"' -I"D:\ScampWorkspace4\lpc_chip_43xx_m0\inc" -I"D:\ScampWorkspace4\s5d_m0\inc" -I"D:\ScampWorkspace4\s5d_m4\inc" -O2 -fno-common -g -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fno-rtti -fno-exceptions -mcpu=cortex-m0 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
